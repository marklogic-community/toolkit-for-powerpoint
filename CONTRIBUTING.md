# Contributing to the MarkLogic Toolkit for PowerPoint
...
Fork the project [on GitHub](https://github.com/marklogic-community/toolkit-for-powerpoint/fork) and clone
your copy.

```sh
$ git clone git@github.com:username/toolkit-for-powerpoint.git
$ cd toolkit-for-powerpoint
$ git remote add upstream git://github.com/marklogic-community/toolkit-for-powerpoint.git
```
...
Go to https://github.com/username/toolkit-for-powerpoint and select your feature branch. Click
...
[issue tracker]: https://github.com/marklogic-community/toolkit-for-powerpoint/issues
